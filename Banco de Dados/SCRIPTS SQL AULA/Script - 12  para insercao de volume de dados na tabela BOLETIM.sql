...
BULK INSERT FmuBDTercaFeira.tTerNoite.BOLETIM
-- Define-se o caminho e nome do arquivo fonte.
FROM 'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\BOLETIM.csv'
WITH
(
 FORMAT = 'CSV',
 DATAFILETYPE	='char',
 ...
 ERRORFILE='C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\boletimERROS.txt'
);